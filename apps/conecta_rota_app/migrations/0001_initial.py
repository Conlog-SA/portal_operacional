...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Param_RV_Rota',
            fields=[
                ('cod_param_rv_rota', models.AutoField(auto_created=True, editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Registro_2art_Rota',
            fields=[
                ('cod_reg_2art_rota', models.IntegerField(primary_key=True, serialize=False)),
                ...
                ('cod_param_rv_rota', models.ForeignKey(db_column='cod_param_rv_rota', on_delete=django.db.models.deletion.DO_NOTHING, to='conecta_rota_app.Param_RV_Rota')),
