                ...
                try:
                    ...
                    if obj_registro_2art == None:
                        ...
                        obj_registro_2art_new = Registro2Art(
                            ...
                            regiaospot=str(int(row['regiaospot'])),
                            ...
                            codfilial=str(int(row['codfilial'])),
                        ...
                        obj_registro_2art.regiaospot = str(int(row['regiaospot']))
                        ...
                        obj_registro_2art.entregas = str(int(row['entregas']))
                        ...
                        obj_registro_2art.cxrota = str(int(row['cxrota']))
                        obj_registro_2art.cxas = str(int(row['cxas']))
