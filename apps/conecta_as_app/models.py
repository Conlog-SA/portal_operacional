...
class Param_RV_AS(models.Model):
    cod_param_rv_as = models.AutoField(primary_key=True, editable=False, auto_created=True)
...
class Registro_2art_AS(models.Model):
    cod_reg_2art_as = models.IntegerField(primary_key=True)
    ...
    cod_param_rv_as = models.ForeignKey(Param_RV_AS, models.DO_NOTHING, db_column='cod_param_rv_as')
    class Meta():
        managed = True
