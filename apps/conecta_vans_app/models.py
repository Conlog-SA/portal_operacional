...
class Param_RV_Van(models.Model):
    cod_param_rv_van = models.AutoField(primary_key=True, editable=False, auto_created=True)
...
class Registro_2art_Van(models.Model):
    cod_reg_2art_van = models.IntegerField(primary_key=True)
    ...
    cod_param_rv_van = models.ForeignKey(Param_RV_Van, models.DO_NOTHING, db_column='cod_param_rv_van')
    class Meta():
        managed = True
