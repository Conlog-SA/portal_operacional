...
class Form_cad_equipamentos_veiculos(View):
    def post (self, request):
        ...
        if cod_cad_sinistro_eqp_veic == '0':  #Verifica se o código do Botão é 0 ou seja se não tem nada cadastrado ainda, se for 0 ele executa o bloco.
            sinistro = CCO_Sinistro(
                data_inclusao = datetime.utcnow(),
            ...
            obj_sinistro.cod_estado = OP_Estados.objects.get(pk=estado_sinistro_eqp).cod_estado
