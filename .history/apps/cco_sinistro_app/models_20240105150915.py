...
class CCO_Sinistro_Equipamento(models.Model):
    ...
    val_indenizado = models.DecimalField(null=True, blank=True, max_digits=20, decimal_places=2)
    val_prejuizo = models.DecimalField(null=True, blank=True, max_digits=20, decimal_places=2)
