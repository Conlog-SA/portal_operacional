...
class Gente_Gestao_Punicao(models.Model):
    ...
    cod_mot_juridico = models.ForeignKey(Gente_Gestao_Motivo_Juridico, models.DO_NOTHING, db_column='cod_mot_juridico', null=False, blank=False)
    cod_usu = models.ForeignKey(Usuario, models.DO_NOTHING, db_column='cod_usu', null=False, blank=False)
    cod_mot_especifico = models.ForeignKey(Gente_Gestao_Motivo_Especifico, models.DO_NOTHING, db_column='cod_mot_especifico', null=True, blank=True)
    cod_desativacao = models.ForeignKey(Gente_Gestao_Desativacao, models.DO_NOTHING, db_column='cod_desativacao', null=True, blank=True)
...
class Gente_Gestao_Desativacao(models.Model):
    ...
    motivo_desativacao = models.CharField(max_length=300, null=True, blank=True)
