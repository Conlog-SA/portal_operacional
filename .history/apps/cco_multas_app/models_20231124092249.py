...
class CCO_Anexos(models.Model):
    ...
    caminho_anexo = models.CharField(null=False, blank=True, max_length=50)
    cod_multa_antt = models.ForeignKey(CCO_Multas, models.DO_NOTHING, db_column='cod_multa_antt')
