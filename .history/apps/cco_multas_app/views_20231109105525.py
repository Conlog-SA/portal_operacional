...
class Anexar_Itens(View):
    def handle_uploaded_file(self,f):
        with open('172.16.40.29/portal_operacional/proj_portal_operacional/arquivos_multas_notificacoes/' +f.name, 'wb+') as destination:
            for chunk in f.chunks():
                destination.write(chunk)
                
    def download_file(self,request, filename):
    file_path = '172.16.40.29/portal_operacional/proj_portal_operacional/arquivos_multas_notificacoes/' + filename
