...
class Multas_View(View):
    def get(self, request):
        ...
        lista_infracoes = list(CCO_Multas.objects.filter().values('num_auto_infracao'))

        contexto = {
            'lista_projetos': lista_projetos,
            'lista_tipo_multa': lista_tipo_multa,
            'lista_placas': lista_placas,
            'lista_infracoes' : lista_infracoes,
        }
...
class Pesquisa_Multa_View(View):
    def get(self, request):
        ...
        if tipo_pesquisa == 'placa':
            ...
            queryNumAutuacao = CCO_Multas.objects.filter(numero_autuacao = num_infracao_selecionada)
