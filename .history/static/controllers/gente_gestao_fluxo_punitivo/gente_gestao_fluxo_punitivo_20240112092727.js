...
btnModalCadDesativacaoFluxo = document.getElementById('btn_desativa_fluxo_punitivo');
btnModalCadDesativacaoFluxo.addEventListener('click', function() {
        ...
        success: function(data) {
            ...
            data.linhas_tabela.forEach( linha => {
                    let let_linha = [
                        ...
                        `
                        <button type='button'
                            id="btn_desativa_fluxo_punitivo"
                            name="btn_desativa_fluxo_punitivo"
...
function abrirModal(nome_modal) {
    if (nome_modal === 'fluxo_punitivo') {
        $("#modal_desativa_punicao").show();
    }
}
