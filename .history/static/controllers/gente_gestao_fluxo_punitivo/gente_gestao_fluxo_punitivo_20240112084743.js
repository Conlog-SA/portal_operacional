...
btnModalCadDesativaFluxo.addEventListener('click', function(){
    ...
    btnFechaModalDesativaFluxo = document.getElementById('btn_fecha_modal_desativa_fluxo'); // coleta o evento do clitque no botão
    btnCancelaModalDesativaFluxo = document.getElementById('btn_cancela_modal_desativa_fluxo');
    
    btnFechaModalDesativaFluxo.addEventListener('click', function() {//Fecha o modal quando clica em fechar
        $("#modal_desativa_punicao").hide();
    })
    btnCancelaModalDesativaFluxo.addEventListener('click', function() {//Fecha o modal quando clicar em cancelar
        $("#modal_desativa_punicao").hide();
    })    
