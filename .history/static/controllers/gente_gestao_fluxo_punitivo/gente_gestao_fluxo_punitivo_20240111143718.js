            ...
            data.linhas_tabela.forEach( linha => {
                let let_linha = [
                    ...
                    linha.motivo_especifico,
                    {
                        render: function () {
                            return `
                                <input type="checkbox" class="checkbox" name="toogle_desativa_ocorrencia_${linha.matricula}"
                                        id="toogle_desativa_ocorrencia_${linha.matricula}">
                                <label class="switch" for="toogle_desativa_ocorrencia_${linha.matricula}">
