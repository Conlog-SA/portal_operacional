...
$(document).on('click','button', function(){
    ...
    if (let_name_btn == 'btn_abre_modal_desativa_fluxo_pun'){

        $("#modal_desativa_punicao").modal('toggle');
    }
});
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            data.linhas_tabela.forEach( linha => {
                    let let_btn_exclui_punicao = `
                        <button type='button'
                            id="btn_abre_modal_desativa_fluxo_pun"
                            name="btn_abre_modal_desativa_fluxo_pun"
                            class="btn btn-primary btn-rounded btn_desativa_fluxo_punitivo"
