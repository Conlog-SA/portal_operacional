    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            data.linhas_tabela.forEach( linha => {
                    let var_rb_ativa_periodo =
                    `<div class="container">
                    <input type="checkbox" class="checkbox"
                           name="rbn_ativa_periodo"
                           id="rbn_ativa_periodo_${linha.ano_competencia_periodo}_${linha.mes_competencia_periodo}_${linha.periodo}"
                           ${linha.acao}>
                    <label class="switch" for="rbn_ativa_periodo_${linha.ano_competencia_periodo}_${linha.mes_competencia_periodo}_${linha.periodo}">
            ...
            $('#table_fluxo_punitivo').DataTable( {
                ...
                "columnDefs": [
                    {"className": "dt-left", "targets": [0, 1, 2, 3, 4, 5, 6]}, // Aplica classe text-left a todas as colunas
                    {"className": "text-left", "targets": [0, 1, 2, 3, 4, 5, 6]}, // Aplica classe text-left a todas as colunas
                    { "width": "10%", "targets": 0 },
