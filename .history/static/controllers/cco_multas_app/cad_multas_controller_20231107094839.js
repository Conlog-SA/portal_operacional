...
$(document).on('click','button', function(){
    ...
    if(let_name_btn == 'btn_excluir_multa'){
        ...
        $("#input_proj").val(let_lista_multas_bd[let_indice_tabela]22222222222222222222222222[2]);
        ...
        $("#input_valor_pago_infracao").val(let_lista_multas_bd[let_indice_tabela][11]);
        $("#input_valor_infracao").val(let_lista_multas_bd[let_indice_tabela][12]);
        $("#dt_pagamento_multa").val(let_lista_multas_bd[let_indice_tabela][13]);
        $("#txt_obs").val(let_lista_multas_bd[let_indice_tabela][14]);
        $("#input_codigo_infracao").val(let_lista_multas_bd[let_indice_tabela][17]);
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            let_lista_multas_bd = data.linhasTabela.map(linha => [
                ...
                `,
                /* 11 */linha.valor_pago,
                /* 12 */linha.valor_pagar,
                /* 13 */linha.data_pag_multa,
                /* 14 */linha.obs,
                /* 15 */linha.data_inclusao,
                /* 16 */linha.cod_multa_antt,
                /* 17 */linha.cod_infracao,
                /* 18 */let_indice_registro += 1
            ])
