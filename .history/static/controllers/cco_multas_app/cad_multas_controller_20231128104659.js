        ...
        success: function(data) {
            let let_visualiza_tabela = data.lista_anexos_multa.map(linha => [
                ...
                <button type='button'
                    ...
                    <i class="fa-solid fa-magnifying-glass-plus" style="background-color: #f46424; border-color:#f46424"></i>
                </button>
                ` ,
                `
                <button type='button' id="btn_excluir_anexo"
                    ...
                    title="Excluir Anexo">
                    <i class="fa-solid fa-trash-can" style="background-color: #f46424"; border-color:#f46424;></i>
                </button>
                `
            ]);
