        ...
        let let_cod_anexo = let_value_btn;
           $.ajax({
                ...
                success: function(data){
                    ...
                    atualiza_tab_pesquisa_anexo(let_cod_anexo);
                },
                error: function(request, status, error){
                    $.gritter.add({
                        title: 'Atenção!',
        ...
        success: function(data) {
            let let_visualiza_tabela = data.lista_anexos_multa.map(linha => [
                ...
                <button type='button'
                    ...
                    name="btn_visualizar_anexo_${linha.cod_multa_att}"
            ...
            $('#tab_anexos_conta').DataTable().clear().destroy();
           ...
           $('#tab_anexos_conta').DataTable().ajax.reload();
        },
        error: function(error) {
            $.gritter.add({
                title: 'Erro!',
